...
class RSAEncryption:
    def __init__(self, env_file_path=None):
        ...
        self.public_key_path = os.getenv('PUBLIC_KEY_PATH', os.path.join(script_directory, 'rsa_crypto_python/keys/public_key.pem'))
        self.private_key_path = os.getenv('PRIVATE_KEY_PATH', os.path.join(script_directory, 'rsa_crypto_python/keys/private_key.pem'))
